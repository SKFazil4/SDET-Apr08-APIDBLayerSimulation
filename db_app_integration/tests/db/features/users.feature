Feature: User Table DB operations
  ...
  Scenario: Create a new user successfully
    Given I have a user payload with name "hehe" and email "hehe@example.com"
  ...
  Scenario: Fail to insert user with duplicate name
    ...
    When I try to insert another user with name "kate" and email "kate@example.com"
    Then the database should raise a uniqueness constraint error

  Scenario: Fail to insert user with duplicate email
    Given a user already exists with name "winslet" and email "winslet@example.com"
    When I try to insert another user with name "winslet" and email "winslet@example.com"
    Then the database should raise a uniqueness constraint error
